...
//We can also initialize a variable by giving it a value when we name it
...
console.log(shoe);  // => logs undefined   the code recognizes shoe, but its value is not yet available in the code
